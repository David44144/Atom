...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("ATO");
    case cBTC: return QString("cATO");
    case mBTC: return QString::fromUtf8("mATO");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Atoms");
    case cBTC: return QString("Centum-Atoms (1 / 100)");
    case mBTC: return QString("Milli-Atoms (1 / 1,000)");
    default: return QString("???");
    }
}
